...
### Q1. Why do databases use large blocks?

Large blocks improve:
...
### Q2. Why did 4KB blocks reduce performance?

Because fragmentation increased:
...
### Q3. Why didn’t DuckDB crash?

Because Row Groups abstract logical execution from physical storage.

---

### Q4. What is vectorized execution?

Processing multiple rows together in chunks instead of row-by-row execution.

---

### Q5. What is metadata thrashing?

Excessive CPU overhead caused by managing too many fragmented metadata entries.
